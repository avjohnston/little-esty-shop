...
RSpec.describe "Admin Dashboard" do
  before :each do
    ...
    @transaction_4 = create(:transaction, result: 0, invoice_id: @invoice_4.id)
    @transaction_5 = create(:transaction, result: 0, invoice_id: @invoice_5.id)

    ii_1 = create(:invoice_item, invoice_id: @invoice_1.id, status: 1)
    ii_2 = create(:invoice_item, invoice_id: @invoice_1.id, status: 1)
    ii_3 = create(:invoice_item, invoice_id: @invoice_2.id, status: 2)
    ii_4 = create(:invoice_item, invoice_id: @invoice_2.id, status: 2)
    ii_5 = create(:invoice_item, invoice_id: @invoice_3.id, status: 1)
    ...
    @transaction_24 = create(:transaction, result: 0, invoice_id: @invoice_24.id)
    @transaction_25 = create(:transaction, result: 1, invoice_id: @invoice_25.id)

    ii_21 = create(:invoice_item, invoice_id: @invoice_24.id, status: 1)
    ...
    @transaction_34 = create(:transaction, result: 1, invoice_id: @invoice_34.id)
    @transaction_35 = create(:transaction, result: 1, invoice_id: @invoice_35.id)
    ...
    @transaction_44 = create(:transaction, result: 1, invoice_id: @invoice_44.id)
    @transaction_45 = create(:transaction, result: 1, invoice_id: @invoice_45.id)
    ...
    @transaction_54 = create(:transaction, result: 0, invoice_id: @invoice_54.id)
